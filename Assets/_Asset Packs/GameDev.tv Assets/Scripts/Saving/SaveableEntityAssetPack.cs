...
namespace GameDevTV.SavingAssetPack
{
    ...
    /// </summary>
    [ExecuteAlways]
    public class SaveableEntityAssetPack : MonoBehaviour
    {
        // CONFIG DATA
        ...
        // CACHED STATE
        static Dictionary<string, SaveableEntityAssetPack> globalLookup = new Dictionary<string, SaveableEntityAssetPack>();
        ...
        public object CaptureState()
        {
            ...
            foreach (ISaveableAssetPack saveable in GetComponents<ISaveableAssetPack>())
            {
